...
namespace VisualMaster.CameraLink
{
    public class CameraSettingsControl : UserControl
    {
        ...
        private void BuildUI()
        {
            ...
            {
                _cmbTriggerSource.Enabled = _chkTriggerEnabled.Checked && !_isReadOnly;
                _cmbTriggerActivation.Enabled = _chkTriggerEnabled.Checked && !_isReadOnly;
            };
            Controls.Add(_chkTriggerEnabled);
            y += 30;
        ...
        {
            _chkTriggerEnabled.Enabled = !_isReadOnly;
            _cmbTriggerSource.Enabled = !_isReadOnly && _chkTriggerEnabled.Checked;
            _cmbTriggerActivation.Enabled = !_isReadOnly && _chkTriggerEnabled.Checked;
